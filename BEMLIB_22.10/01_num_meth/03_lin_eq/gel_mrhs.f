...
c  with the option of row pivoting.
c 
...
c---------------------------------------------------------------
      ...
      Dimension a(500,500),rhs(500,500),c(500,506),u(500,500)
...
c--------------------------------
      ...
      If(abs(c(n,n)).lt.eps) then
        write (6,*)
        write (6,*) " gel_mrhs: trouble at station 2"
        Istop = 1
        Return
      End If
...
c------------------------
      ...
      If(Iwlpvt.eq.1) then
        write (6,*)
        write (6,*) " gel_mrhs: Number of row interchanges : ",Icount
        write (6,*)
        Do i=1,icount
          det = -det
        End Do
