...
c------------------------------------------------
c Computes the integral of a nonsingular function 
c using the Radau quadrature
c------------------------------------------------
...
c-----------------
  ...
  97  Continue
      ...
      write (6,*) ' Please enter the number of base points'
      write (6,*) ' Choose from 1, ..., 6'
      write (6,*)
      write (6,*) ' 0 to quit'
      write (6,*) ' ---------'
      read  (5,*) NQ
