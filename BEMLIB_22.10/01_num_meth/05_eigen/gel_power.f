...
c-------------------------------------------------------------
      ...
      Dimension a(512,512),rhs(512),c(512,513),u(512,512)
      Double Precision l(512,512)
      Dimension x(512)
...
c       write (6,*) " gel_power: number of row interchanges : ",Icount
...
c----------------------
      ...
      Do i=1,n
        ...
        If(abs(sum).gt.tol) then
          Istop = 1
          write (6,*) " gel_power: problem in solving the linear system"
          write (6,100) i,sum
        End If
