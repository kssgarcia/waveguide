...
% FDLIB, BEMLIB
%
% Triangulation of a square patch
% in the xy plane into 6-node triangles
%
% The patch is confined in -1< x,y <1
%================================

% --------
% parental structure with 8 elements
% --------
...
y(5,5) = 0.5*(y(5,2)+y(5,3));efl(5,5)=1;
...
x(7,4) = 0.5*(x(7,1)+x(7,2));
y(7,4) = 0.5*(y(7,1)+y(7,2));efl(7,4)=0;
x(7,5) = 0.5*(x(7,2)+x(7,3));
y(7,5) = 0.5*(y(7,2)+y(7,3));efl(7,5)=1;
x(7,6) = 0.5*(x(7,3)+x(7,1));
y(7,6) = 0.5*(y(7,3)+y(7,1));efl(7,6)=0;

x(8,1) = 0.0; y(8,1) = 0.0; efl(8,1) = 0;  % eighth element
x(8,2) = 1.0; y(8,2) =-1.0; efl(8,2) = 1;
x(8,3) = 1.0; y(8,3) = 0.0; efl(8,3) = 1;
x(8,4) = 0.5*(x(8,1)+x(8,2));
y(8,4) = 0.5*(y(8,1)+y(8,2));efl(8,4)=0;
x(8,5) = 0.5*(x(8,2)+x(8,3));
y(8,5) = 0.5*(y(8,2)+y(8,3));efl(8,5)=1;
x(8,6) = 0.5*(x(8,3)+x(8,1));
y(8,6) = 0.5*(y(8,3)+y(8,1));efl(8,6)=0;
