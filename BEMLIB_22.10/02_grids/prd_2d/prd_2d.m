...
%  FDLIB, BEMLIB
%
% Point redistribution on a CLOSED 2D line
% in the xy plane
%
...
%-----------------------------------
 ...
 if(Italk==1)
  ...
  %---
      ...
      Xinterp1 = (Xint(N)+2.0*Xint(N1))/3.0;
      DX = Xinterp1-Xint(N);
     ...
     ...
      ...
      ,Xinterp1-Xintsave ...
      ,P1(Na)-P1save,P1(N)-P1save,P1(1),P1(2) ...
      ,P2(Na),       P2(N),P2(1),P2(2) ...
      );
...
%     [P1(N-1)-P1(N1),P1(N)-P1(N1),P1(1),P1(2)]
      ...
      Xinterp2 = (2.0*Xint(1)+Xint(2))/3.0;
      DX = Xinterp2-Xint(1);
...
...
  ...
  %---
   ...
   N = N1;
   if(Italk==1)
    disp ('prd_2d: one point inserted; segments :'); disp(N);
   end
   Irepeat = 1;
   Iaction = 1;
   return
