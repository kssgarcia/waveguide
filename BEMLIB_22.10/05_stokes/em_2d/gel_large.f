...
c-------------------------------------------------------------
      ...
      Dimension a(3200,3200),rhs(3200),c(3200,3201)

c     Dimension u(500,500)
c     Double Precision l(3200,3200)
...
c--------------------------------
      ...
      If(abs(c(n,n)).lt.eps) then
        ...
        write (6,*) " of Gauss elimination in subroutine gel"
        write (6,*) 
        Istop = 1
        Return
