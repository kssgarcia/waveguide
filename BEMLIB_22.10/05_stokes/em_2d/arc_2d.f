...
c		each one of the three points
c
...
c---
     ...
     +             +2.0D0*R*XC*(0.5D0*DTH+0.25*DSIN2)
     +             +R**2    *(DSN-DSN3/3.0D0) )
...
c     If(Iarc.eq.2) then
c      write (6,*)
c      write (6,100) X1,X2,X3
c      write (6,100) Y1,Y2,Y3
c      write (6,100) XX1,XX2,XX3
c      write (6,100) YY1,YY2,YY3
c      write (6,*) XC,YC,R
c      write (6,*) TH1,TH2,TH3
c      write (6,*)
c     End If
