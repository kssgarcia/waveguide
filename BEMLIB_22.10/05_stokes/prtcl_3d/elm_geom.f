...
c  (b) the x, y, and z moments over each element
c  (c) the total particle surface area and volume
c  (d) the mean curvature of each element
c  (e) the average value of the
...
c---
c project curvature vector onto the normal
