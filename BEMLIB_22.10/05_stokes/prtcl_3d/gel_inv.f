...
c-------------------------------------------------
c  Computate the inverse of a matrix
...
c  the upper and lower triangular factors,
...
c---------------------------------------------------------------
      ...
      Dimension a(1600,1600),c(1600,3200),u(1600,1600)
      Double Precision l(1600,1600)
      Dimension x(1600,1600)
...
c---
      if(Iwlpvt.eq.1) then   ! perform pivoting
c---
...
c      End Do
      ...
      End Do  ! end of outer loop for working row
