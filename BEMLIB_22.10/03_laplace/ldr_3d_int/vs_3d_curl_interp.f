...
c-------------------------------------------------
c Computes the Frechet derivative of the potential
c--------------------------------------------------
...
c---
c  compute dx/dxi and D ptl/dxi 
c  from xi derivatives of phi
c---
...
c---
c  compute dx/deta and D ptl/deta
c  from eta derivatives of phi
c---
...
c---
c  raw normal vector:  vn = (DxDxi)x(DxDeta)
c---
...
c--------------------------------
c compute the frechet derivatives
c by solving three sets of three linear systems
c--------------------------------
