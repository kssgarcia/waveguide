...
c----------------------------------
      ...
      Dimension f(1090),vort(1090,3)
      Dimension vorta(1090,3),vorta_sv(1090,3)
...
c---
      ...
      Do i=1,6
        ...
        call vs_3d_2p_circ_vort_interp
     +
...
c---
      ...
      Do 76 i=1,npts
       ...
       vorta_sv(i,1) = vorta(i,1)
       vorta_sv(i,2) = vorta(i,2)
       vorta_sv(i,3) = vorta(i,3)
      ...
      Do 77 i=1,npts
       ...
       If(noim.eq.0) Go to 77  ! no images
        ...
        Do j=2,noim+1     ! Iedge(i,1) images
         image = Iedge(i,j)
         vorta(i,1) = vorta(i,1) + vorta_sv(image,1)
         vorta(i,2) = vorta(i,2) + vorta_sv(image,2)
         vorta(i,3) = vorta(i,3) + vorta_sv(image,3)
        End Do

        noim1 = noim+1

        vorta(i,1) = vorta(i,1)/noim1
        vorta(i,2) = vorta(i,2)/noim1
        vorta(i,3) = vorta(i,3)/noim1
