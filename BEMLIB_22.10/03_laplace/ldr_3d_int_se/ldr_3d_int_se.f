...
c at the closed (external) boundary of the
c solution domain
c
c The solution is represented in terms of a dipole
c distribution over the external boundary
c
c SYMBOLS:
c -------
c
...
c-----------
      ...
      write (6,*) ' Enter:'
      write (6,*)
      write (6,*) ' 1 to read them from file: ldr_3d_int_se.dat'
...
c-----------
  ...
  91  Continue
      ...
      write (6,*)
      write (6,*) " Enter the ratios b/a and c/a"
      write (6,*) " ----------------------------"
      read  (5,*) boa,coa

      write (6,*)
      write (6,*) " Please enter the equivalent radius"
      write (6,*) " of the ellipsoid"
      write (6,*) " ----------------"
      read  (5,*) req

      write (6,*)
      write (6,*) " Enter the coordinates"
      write (6,*) " of the center of the ellipsoid"
      write (6,*) " ------------------------------"
      read  (5,*) cxp,cyp,czp
...
c       write (6,*) alpha(k),beta(k),gamma(k)
...
c-------------------------------------------------
      ...
      Do k=1,nelm    ! loop over elements
       ...
       Ic = 0  ! count element spectral nodes
...
c      write (6,100) i,f(i),dpl(i),dlp_pv(i),area
...
c     Do k=1,nelm
c      Do i=1,nesp
c       write (4,102) xsp(k,i),ysp(k,i),zsp(k,i)
c      End Do
c     End Do

c     write (1,*) 2*nesp
c     Do i=1,nesp
c      write (4,102) xsp(1,i),ysp(1,i),zsp(1,i)
c     End Do
c     Do i=1,nesp
c      write (4,102) xsp(2,i),ysp(2,i),zsp(2,i)
c     End Do
