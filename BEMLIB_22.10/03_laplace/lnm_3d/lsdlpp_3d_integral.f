...
c--------------------------------------
c compute the single-layer and the double-layer
c Laplace potential at the point: x0, y0, z0
...
c---
      ...
      Iopt_int = 2   ! for interpolation: need the surface metric
      Iopt_lgf = 2   ! need G and grad(G)
...
c---
     ...
     +      ,f(i1),f(i2),f(i3)
     +      ,f(i4),f(i5),f(i6)
     +      ,dfdn(i1),dfdn(i2),dfdn(i3)
     +      ,dfdn(i4),dfdn(i5),dfdn(i6)
     +
     +      ,al,be,ga
     +      ,xi,eta
     +      ,x,y,z
...
c---
      ...
      rint = - dfdn_int*G + fint*(vnx*Gx + vny*Gy + vnz*Gz)
