...
c-------------------------------------------
c  Utility of the single- double-layer integrator:
c
c  interpolates over an element for the:
c
c  position vector
c  normal vector
c  the scalar densities q and u
...
c---------------------------------
c interpolate the scalar densities
c---------------------------------

      qint = q1*ph1 + q2*ph2 + q3*ph3
     +     + q4*ph4 + q5*ph5 + q6*ph6

      uint = u1*ph1 + u2*ph2 + u3*ph3
     +     + u4*ph4 + u5*ph5 + u6*ph6

c     If(Iopt_int.eq.1) Go to 99
