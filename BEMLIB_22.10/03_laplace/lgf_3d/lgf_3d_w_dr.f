...
c in a semi-infinite domain bounded
...
c-----------
      ...
      Iopt = 2    ! compute the Green function and gradient
...
c------
      ...
      write (6,*) ' 2 to test integral identities in a sphere'
      write (6,*) ' -----------------------------------------'
      read  (5,*) menu
      ...
      write (6,*)
      write (6,*) ' Wall is located at x = wall'
      write (6,*)
